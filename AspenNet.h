...
int socket;     // Global int for the socket to be used (perhaps this should be configure in the conf file?)
//char *Aspen_Mach_Path = NULL;      // Global for path and name of Aspen model
//char *Aspen_App_Path = NULL;        // Global for path and name of Aspen application/kernel
